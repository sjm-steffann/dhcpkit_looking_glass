    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_request_ll', models.GenericIPAddressField(null=True, protocol='ipv6', blank=True, verbose_name='Link-local address')),
                ...
                ('last_response_ts', models.DateTimeField(null=True, blank=True, verbose_name='Last response timestamp')),
            ],
            options={
                'db_table': 'clients',
            },
